...
def init_db():
    ...
    cursor.execute("INSERT OR IGNORE INTO profiles (role, name, phone, about, rating, rating_count) VALUES ('worker', 'Михаил Лупу', '+373 79 987 654', 'Иполнитель из Комрата.', 5.0, 1)")

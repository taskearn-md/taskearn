...
def init_db():
    """Создает чистую базу данных v12 с отзывами, штрафами заказчиков и мягким падением рейтинга"""
    conn = sqlite3.connect("taskearn_v12.db")
    cursor = conn.cursor()
                    ...
                    with st.container():
                        ...
                        with col1:
                            ...
                            if task['status'] == "На проверке":
                                ...
                                st.warning("Ожиждает проверки заказчиком")
